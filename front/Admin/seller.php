    ...
    <div id="wrapper" style="display:none;height: 700px;overflow: auto;">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <form class="form-inline d-none d-sm-inline-block mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                            <div class="input-group">
                                <input class="bg-light form-control border-0 small" type="text" id="seller" placeholder="Recherchez " oninput="filter_liste()">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">Vendeurs&nbsp;</h3>
                <!-- <div class="row">
                    <div class="col-4">           
                        <div class="input-group mb-3 d-flex justify-content-end">
                          <input type="text" class="form-control" placeholder="" aria-label="Recipient's username" aria-describedby="basic-addon2">
                          <div class="input-group-append">
                            <button class="btn btn-outline-info btn-info text-white shadow-none" type="button">Search</button>
                          </div>
                        </div>
                    </div>
                </div> -->
