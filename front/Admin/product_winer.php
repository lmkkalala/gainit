    ...
    <div id="wrapper" style="display:none;height: 700px;overflow: auto;">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">GAGNANTS D'ARTICLES</h3>
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">LISTE DES GAGNANTS&nbsp;</p>
                    </div>
                    <div class="card-body">
                        <!-- <div class="row">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                            ...
                            <?php 
                                $number = 1; 
                                foreach ($products_show_vendu_admin as $key => $value): 
                                    $seller = $this->db->get_where('user',array('id'=>$value->seller_id))->result_array();
                            ?>
                                    <tr>
                                        <!-- <td><?=$number?></td> -->
                                        <td>
                                            ...
                                            <img class="rounded-circle mr-2" width="70" height="40" src="<?=base_url('assets/img/user/').$value->profile?>" style="background-color: #ffffff;">
                                        </td>
                                        <td><?=$value->username?></td>
                                        <td>
                                            <img class="rounded mr-2" width="70" height="40" src="<?=base_url('dist/produit/').$value->caption_image?>" style="background-color: #ffffff;">
                                        </td>
                                        <td><?=$value->product?></td>
                                        <td><?=$seller[0]['store_name']?></td>
                                        <td> <?=$seller[0]['username']?></td>
                                        <td><?=$value->date?></td>
