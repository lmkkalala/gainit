            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">Liste des utilisateurs inscrits&nbsp;</p>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6"><button class="btn btn-primary" type="button">Ajouter Admin</button>
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                            <table class="table my-0" id="dataTable">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img class="rounded-circle mr-2" width="70" height="40" src="<?=base_url()?>assets_admin/img/Fanta-Logo.png" style="background-image: url(&quot;<?=base_url()?>assets_admin/img/Fanta-Logo.png&quot;);background-repeat: no-repeat;background-size: cover;background-color: #ffffff;">labotté</td>
                                        <td
                                            class="text-center"><button class="btn btn-primary" type="button">supprimer</button></td>
                                    </tr>
                                    <tr>
                                        <td><img class="rounded-circle mr-2" width="71" height="40" src="<?=base_url()?>assets_admin/img/Fanta-Logo.png">amigo</td>
                                        <td class="text-center"><button class="btn btn-primary" type="button">supprimer</button></td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr></tr>
