            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">Gerer les admins <button class="btn btn-primary" type="button"  data-toggle="modal" data-target="#add_admin">+ Ajouter Admin</button></p>
                    </div>
                    <div class="card-body">
                        <!-- <div class="row">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                            <table class="table my-0" id="example">
                                ...
                                <tbody>
                                    <?php 
                                        foreach ($admin_show as $key => $value):
                                    ...
                                    ?>
                                      <tr>
                                        <td>
                                            <img class="rounded-circle mr-2" width="70" height="40" src="<?=base_url('assets/img/user/'.$value->profile)?>">
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-primary mt-1" type="button" onclick="block_admin(<?=$value->id?>)" style="font-size:12px;"><i id="icon<?=$value->id?>" class="<?=$icon?>"></i></button>
                                            <button class="btn btn-info mt-1" type="button" data-toggle="modal" data-target="#update_admin" data-id="<?=$value->id?>" style="font-size:12px;"><i class="fas fa-edit"></i></button>
                                            <button class="btn btn-danger mt-1" type="button" onclick="delete_admin(<?=$value->id?>)" style="font-size:12px;"><i class="fas fa-trash"></i></button>
                                        </td>
                                    </tr>  
                                    <?php endforeach; ?>
                                </tbody>
  ...
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="user" id="AddAdminForm">
            <div class="form-group row">
                <div class="col-sm-12 mb-3 mb-sm-0">
                    <div class="row">
                        <div class="col-md-12">
                            <input class="form-control form-control-user" type="text" placeholder="Selectionner Image Profile" disabled>
                        </div>
                ...
                <div class="col-sm-12 mb-3 mt-2 mb-sm-0">
                    <input class="form-control form-control-user" type="text" id="name" placeholder="Noms" name="name" required="">
                </div>
                <div class="col-sm-12 mt-2">
                    <input class="form-control form-control-user" type="email" id="email" placeholder="Address mail" name="email" required="">
                </div>
            </div>
            <div class="form-group mt-2">
                <input class="form-control form-control-user" type="tel" id="phone" aria-describedby="phone" placeholder="Téléphone " name="phone" required="">
            </div>
            <div class="form-group row">
                <div class="col-sm-12 mb-3 mb-sm-0">
                    <input class="form-control form-control-user" type="text" id="country" placeholder="Pays" name="country" required="">
                </div>
                <div class="col-sm-12 mt-2">
                    <input class="form-control form-control-user" type="text" id="province" placeholder="Province" name="province" required="">
                </div>
                <div class="col-sm-12 mt-2">
                    <input class="form-control form-control-user" type="text" id="city" placeholder="Ville" name="city" required="">
                </div>
                <div class="col-sm-12 mt-2">
                    <input class="form-control form-control-user" type="password" id="password" placeholder="Mot de passe" name="password" required="">
                </div>
                <div class="col-sm-12 mt-2">
                    <input class="form-control form-control-user" type="password" id="conf_password" placeholder="Confirmer Mot de passe" name="conf_password" required="">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <button type="submit" id="add_button" class="btn btn-primary w-100">Enregistrer</button>
                </div>
                <div class="col-md-6">
