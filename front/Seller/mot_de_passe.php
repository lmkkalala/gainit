                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-sm-12">
                          ...
                          <h1 class="heading btn btn-primary">Changer Votre mot de passe</h1>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 text-secondary">
                          <input type="password" name="mail" class="form-control" value="">
                        </div>
                      </div>
                      <hr>
                      <div class="row">
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                          <a class="btn btn-primary" href="#">Modifier Mot de Passe</a>
                        </div>
                      </div>
                    </div>
                  </div>
